        ...
        <div className="about-heading">
          <div className="about-section">
            <p className="about-text">
              So, picture this: I'm this total coding newbie, right? Never
              touched the stuff before. But then, I decide to take the plunge
              into the coding world. Along the way, I meet these cool people –
              tech wizards, problem-solving champs – you name it.
              <br />
              ...
              though I'm taking it slow, I've come to realize it's my own pace
              of soaking up this coding thing.
              <br />
